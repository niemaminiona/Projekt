...
public partial class InfoPage : ContentPage
{
	...
	public InfoPage()
	{
        ...
        SearchOnInternetSwitch.IsToggled = SearchOnInternet;
	}
	...
	private void CreateInfo()
	{
        ...
        {
            Entry searchBar = new();
            searchBar.BackgroundColor = Colors.Grey;
            InfoLayout.Add(searchBar);
        }
        else
        {
    ...
    private void searchChanged(object sender, ToggledEventArgs e)
    {
